...
> **Source of truth for contracts:** [contracts_v5.md](contracts_v5.md). Never rename a field
...
```json
{
  ...
  "recentLogs": [
    { "rawAudioText": "slept badly", "detectedConditionId": null,
      "extractedMetrics": {"sleep_hours": 5}, "createdAt": "2026-07-16T22:10:00Z" }
  ],
...
```json
{
  ...
  "pending_triage_update": { "condition_id": "acute_myocardial_infarction", "turn": 1 }
}
```
