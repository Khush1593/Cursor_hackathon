...
> ElevenLabs, or Exa directly. **Source of truth for contracts:** [contracts.MD](contracts.MD).
...
- **Field names frozen.** Need a new field? Update [contracts.MD](contracts.MD) and tell the backend dev first.
